...
public class NativeBitmapFactory {
    ...
    public static void loadLibs() {
        ...
        Log.v("NativeBitmapFactory", "loaded" + nativeLibLoaded);
    }
    ...
    public static void releaseLibs() {
        ...
        nativeIntField = null;
        nativeLibLoaded = false;
        // Log.v("NativeBitmapFactory", "released");
    }
    ...
    private static boolean testLib() {
        ...
        try {
            ...
            Log.v("NativeBitmapFactory", "exception:" + e.toString());
            return false;
        } catch (Error e) {
            return false;
        } finally {
    ...
    public static Bitmap createBitmap(int width, int height, Bitmap.Config config, boolean hasAlpha) {
        if (!nativeLibLoaded || nativeIntField == null) {
            // Log.v("NativeBitmapFactory", "ndk bitmap create failed");
    ...
    private static Bitmap createNativeBitmap(int width, int height, Config config, boolean hasAlpha) {
        ...
        // Log.v("NativeBitmapFactory", "nativeConfig:" + nativeConfig);
        // Log.v("NativeBitmapFactory", "create bitmap:" + bitmap);
