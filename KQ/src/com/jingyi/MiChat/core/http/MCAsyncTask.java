 ...
 * <code>java.util.concurrent</code> package such as {@link Executor},
 ...
 * </p>
 */
@SuppressLint("NewApi") public abstract class MCAsyncTask<Params, Progress, Result> {
	...
	private static Handler getHandler() {
		synchronized (MCAsyncTask.class) {
			if (sHandler == null) {
	 ...
	 *             {@link MCAsyncTask.Status#RUNNING} or
	 *             {@link MCAsyncTask.Status#FINISHED}.
	 * 
	 * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
	 * @see #execute(Runnable)
	 */
	public final MCAsyncTask<Params, Progress, Result> execute(Params... params) {
	 ...
	 * @see #execute(Object[])
	 */
	public final MCAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
	...
	private static class AsyncTaskResult<Data> {
		final MCAsyncTask mTask;
		final Data[] mData;

		AsyncTaskResult(MCAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
