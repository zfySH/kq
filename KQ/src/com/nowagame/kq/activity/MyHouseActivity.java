...
public class MyHouseActivity extends AgentActivity implements OnClickListener {
	...
	public void doShowNearby(final boolean isRefresh, boolean isLazyLoad) {
		doPullDate(isLazyLoad, "2037", new MCHttpCallBack() {
					...
					if (resultCode.equals("0")) {
						...
						if (isRefresh) {
							...
							if (itemsCount > 0) {
								...
								Toast.makeText(MyHouseActivity.this,
			...
			public void onError(MCHttpResp resp) {
				super.onError(resp);
				Toast.makeText(MyHouseActivity.this, resp.getErrorMessage(),
						Toast.LENGTH_SHORT).show();
				// 数据载入关闭提示;
				onFinishLoad();
			}
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				try {
					...
					if (EMGroupManager.getInstance().getGroup(
						...
						// 进入聊天页面
						MobclickAgent.onEvent(MyHouseActivity.this,
								"match_room");
	...
	public void onClick(View v) {
		if (v == add_Btn) {
			MobclickAgent.onEvent(MyHouseActivity.this, "room_creat");
			TCAgent.onEvent(MyHouseActivity.this, "room_creat");
