...
public class MyAddfrendsActivity extends AgentActivity implements
		OnClickListener {
					...
					if (resultCode.equals("0")) {
						...
						if (isRefresh) {
							...
							if (itemsCount > 0) {
								...
								Toast.makeText(MyAddfrendsActivity.this,
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				try {
					...
					if (EMGroupManager.getInstance().getGroup(
						...
						// 进入聊天页面
						Intent intent = new Intent(MyAddfrendsActivity.this,
								ChatActivity.class);
						// it is group chat
						...
						intent.putExtra("roomId", new_list.get(position - 1)
								.getString("id"));
						MyAddfrendsActivity.this.startActivity(intent);
					}
				} catch (Exception e) {
