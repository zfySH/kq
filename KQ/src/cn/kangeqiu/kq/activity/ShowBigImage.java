...
import cn.kangeqiu.kq.task.LoadLocalBigImgTask;
import cn.kangeqiu.kq.utils.ImageCache;
import cn.kangeqiu.kq.widget.photoview.PhotoView;
...
public class ShowBigImage extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (uri != null && new File(uri.getPath()).exists()) {
			...
			// loader.LoadImage(remotepath, image);
		} else {
	...
	private void downloadImage(final String remoteFilePath,
		...
		final CloudOperationCallback callback = new CloudOperationCallback() {
			...
			public void onError(String msg) {
				Log.v("###", "offline file transfer error:" + msg);
