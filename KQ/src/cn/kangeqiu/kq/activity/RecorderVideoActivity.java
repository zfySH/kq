...
import cn.kangeqiu.kq.video.util.Utils;
...
public class RecorderVideoActivity extends BaseActivity implements
	...
	private boolean initCamera() {
		try {
			...
			EMLog.v("video", "init Camera fail " + ex.getMessage());
			return false;
		}
		return true;
	}
							...
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									try {
										...
										EMLog.v("video", "start preview fail "
												+ e1.getMessage());
									}
								}
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		try {
			...
			EMLog.v("video", "start preview fail " + e1.getMessage());
		}
	}
	...
	public void stopRecording() {
		if (mediaRecorder != null) {
			...
			try {
				...
				EMLog.v("video", "stopRecording error:" + e.getMessage());
			}
		}
		releaseRecorder();
	...
	public void sendVideo(View view) {
		if (TextUtils.isEmpty(localPath)) {
			EMLog.v("Recorder", "recorder fail please try again!");
			return;
		}
	...
	public void onError(MediaRecorder mr, int what, int extra) {
		EMLog.v("video", "recording onError:");
		stopRecording();
		Toast.makeText(this,
