...
package cn.kangeqiu.kq.activity.view.wheelview;
...
public class WheelView extends View {
	...
	/** 项目文本颜色 */
	private static final int ITEMS_TEXT_COLOR = 0xFFB0B3B2;

	/** 顶部和底部的阴影颜色 */
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFEFFCF3,
			0x00EFFCF3, 0x00EFFCF3 };
