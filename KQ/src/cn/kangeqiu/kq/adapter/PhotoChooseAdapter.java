...
public class PhotoChooseAdapter extends ArrayAdapter<String> implements
		OnScrollListener {
	...
	public PhotoChooseAdapter(Context context, int textViewResourceId,
	...
	public String getDeleteBmpId() {
		String msg = "";
		for (int i = 0; i < mImage_bs.size(); i++) {
			if (mImage_bs.get(i)) {
				String bmpId = Bimp.bitmapMap.get(array[i]);
				msg += bmpId + ",";
			}
		}
		if (!msg.equals(""))
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			view = LayoutInflater.from(getContext()).inflate(
					R.layout.abc_item_published_grida_choosed, null);
		} else {
			view = convertView;
		}
