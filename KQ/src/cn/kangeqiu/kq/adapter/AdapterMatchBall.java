...
public class AdapterMatchBall extends BaseAdapter {
	...
	public AdapterMatchBall(Activity context) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		try {
			oneHolder.hourseName.setText(records.getJSONObject(position)
					.getString("name"));
			oneHolder.joinedNum.setText(records.getJSONObject(position)
					.getString("member_count"));

			JSONObject creater = records.getJSONObject(position).getJSONObject(
					"creator");
			...
			JSONObject match = records.getJSONObject(position).getJSONObject(
					"match");
			oneHolder.matchName
			...
			EMConversation conversation = EMChatManager.getInstance()
					.getConversation(
							records.getJSONObject(position).getString(
									"huanxin_id"));
